...
class CategoryClassify():
    ...
    def create(self, params=None):
        ...
        return Connector(self.token, model_type='texts', path='/api/v1/text/text_categories', headers=headers).send(method='POST', data=params)
    ...
    def list(self, params=None):
        ...
        return Connector(self.token, model_type='texts', path='/api/v1/text/text_categories').send(method='GET', data=params)
    ...
    def find_id(self, text_id=None):
        ...
        return Connector(self.token,
                         model_type='texts',
                         path='/api/v1/text/text_categories').send(method='GET',
                                                        doc_id=text_id,
                                                        query_str=True)
